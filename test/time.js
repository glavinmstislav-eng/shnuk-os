...
(function() {
    ...
    console.log('[Time] Загрузка приложения часов...');
    ...
    let currentMode = 'analog'; // 'analog' | 'digital'
    ...
    function createUI() {
        ...
        clockContainer.innerHTML = `
            ...
            <div class="date-display" id="dateDisplay">Понедельник, 1 января 2024</div>
        `;
        ...
        // Основная панель (пустая, часы уже сверху)
        ...
        function switchPanel(panelId) {
            ...
            // Скрываем часы на других вкладках
        ...
        function startTimer() {
            ...
            if (timerSeconds === 0) {
                ...
                if (timerSeconds <= 0) { alert('Введите время'); return; }
                updateTimerDisplay();
            }
        ...
        function setAlarm() {
            ...
            if (isNaN(hour) || isNaN(minute) || hour < 0 || hour > 23 || minute < 0 || minute > 59) {
                alert('Введите корректное время (час: 0-23, минуты: 0-59)');
                return;
            }
        ...
        function triggerAlarm() {
            ...
            // Звуковой сигнал через Web Audio
            try {
                ...
                // Если звук не работает - просто визуальный сигнал
            }
        ...
        console.log('[Time] Приложение открыто');
    }
    ...
    window.timeInit = function() {
        console.log('[Time] Открытие...');
        openTime();
    };

    console.log('[Time] Готов. Используйте timeInit()');
