// widget-time.js — Аналоговые часы (исправленный)

(function() {
    'use strict';

    console.log('[Widget] Загрузка аналоговых часов...');

    function createTimeWidget() {
        console.log('[Widget] Создание аналоговых часов...');
        ...
        console.log('[Widget] Аналоговые часы созданы');
    ...
    console.log('[Widget] Аналоговые часы загружены');
